...
Route::group(['namespace' => 'Frontend'], function () {
	...
	Route::group(['middleware' => 'auth'], function () {
		...
		Route::match(['get'], 'project/create-pre', ['as' => 'project.create.pre', 'uses' => 'ProjectController@preCreate']);
		...
		Route::group(['namespace' => 'Discussion'], function () {
			...
			Route::match(['get', 'post'], 'discussion/{id}/delete', ['as' => 'discussion.detail.delete', 'uses' => 'DetailController@delete']);
		});
	...
	*/
	...
	|--------------------------------------------------------------------------
	*/
	Route::match(['get', 'post'], 'tribes/{topic?}', ['as' => 'tribe.list', 'uses' => 'TribeController@index']);
		// tribe ajax
		Route::get('tribes/ajax/{topic}/{location}', ['as' => 'ajax.tribe.list', 'uses' => 'TribeController@index_ajax']);
	Route::match(['get', 'post'], 'projects/{topic?}', ['as' => 'project.list', 'uses' => 'ProjectController@index']);
		// project ajax
		Route::get('projects/ajax/{topic}/{location}', ['as' => 'ajax.project.list', 'uses' => 'ProjectController@index_ajax']);
	...
	|--------------------------------------------------------------------------
	*/
	Route::get('ajax/locations', ['as' => 'ajax.location.list', 'uses' => 'LocationController@index_ajax']);
