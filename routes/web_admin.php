...
Route::group(['prefix' => 'kpRk3J5QD', 'namespace' => 'Backend', 'middleware' => 'is_admin'], function () {
	...
	// language lines
	Route::match(['get', 'post'], 'languagelines', ['as' => 'admin.languageline.list', 'uses' => 'LanguageLineController@index']);
	// ajax for language lines
	Route::match(['post'], 'languagelines/edit', ['as' => 'ajax.admin.languageline.edit', 'uses' => 'LanguageLineController@edit']);
});
