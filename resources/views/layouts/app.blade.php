    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container-fluid">
                <img class="logo" src={{asset('images/home/logo.png')}} />
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item px-4 ml-3">
                              <a class="nav-link signup-or-login " href="{{ route('login') }}">{{ __('Log in') }}</a> or
                              <a class="nav-link signup-or-login" href="{{ route('register') }}">{{ __('Sign Up') }}</a>
                            </li>
                        @else
        ...
        @include('layouts.partials.top_feedback')
