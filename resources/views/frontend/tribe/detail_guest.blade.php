...
<div class="tribe-overview-box">
  ...
  <div class="row tribe-infos">
    ...
    <!-- tribe location -->
    <div class="col-lg-2 tribe-location"><i class="fa fa-map-marker-alt"></i>&nbsp;{{ $tribe->location->name }}</div>
...
<div class="row tribe-members-two-boxes">
  ...
  <div class="col-lg-5">
    ...
    <div class="tribe-project-members-header">
      ...
      <div class="tribe-project-members-title tribe-title-collapse" data-target="#project_members">Projects members are involved in ({{ count($project_members) }})<span class="float-right d-lg-none d-block"><i class="fas fa-angle-right"></i></span></div>
